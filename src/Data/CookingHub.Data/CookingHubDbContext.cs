namespace CookingHub.Data
{
    ...
    public class CookingHubDbContext : IdentityDbContext<CookingHubUser, ApplicationRole, string>
    {
        private static readonly MethodInfo SetIsDeletedQueryFilterMethod =
            typeof(CookingHubDbContext).GetMethod(
                nameof(SetIsDeletedQueryFilter),
                BindingFlags.NonPublic | BindingFlags.Static);

        public CookingHubDbContext(DbContextOptions<CookingHubDbContext> options)
            : base(options)
        {
        }
