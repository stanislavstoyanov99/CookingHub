...
**Cooking Hub** is a team project for Software Technologies course of Technical University of Sofia as an individual assignment. It is a ready-to-use ASP.NET Core application.
...
The graphical interface is simple and user friendly, much similar to that of social media. In the upper side of the web page is located the website logo, menus for navigation purposes and profile buttons ("Register" for new users and "Login" for already registered users). There are two ways to registrate into our system - by using the standard registration form and via Facebook. The middle section of the website presents the informational layer of the app, which generates specific view, compliant with the chosen by the menus data. Lastly, every page has footer section, which contains additional info about the website - "About us", "Subsribe" and reference to social medias. The interface is tailored whether the user is signed in the system or not.
Additional information is written in the "Project description.docx" file in the main directory of the repository.
...
Articles are presented like cards and for convenience, there is a pagination. Each article shows who is the author, the publish date and a short description of it. If you are curious about it, you can easily click the button "Read More".
...
This page gives everything you need to know for one article. Title, author, creation date, category and last but not least - description of the article. Below the article, you can provide your opinion by writing comment. Again there is only one rule - you must be registered or logged in. In the sidebar there is a search bar (search by article title), categories with how many articles are written and recent articles published by users.
...
Статиите са представени като "картички" и за удобство има странициране. Всяка статия показва кой е нейният автор, дата на публикуване и кратко описание. Ако сте любопитни, можете лесно да получите повече информация за нея чрез кликане на бутона "Read More".
...
Тази страница дава всичко необходимо за една статия. Заглавие, автор, дата на публикуване, категория и не на последно място - описание на статията. Под нея, можете да оставите мнение като напишете коментар. Отново тук има едно условие - трябва да бъдете регистрирани или логнати. В страничната лента отдясно можете да използвате търсачката (търсене по заглавие на статия), категориите с броя статии в тях и последните написани статии.
